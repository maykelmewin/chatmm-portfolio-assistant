...
function AlertDialogContent({
  ...
  children,
  ...props
}: React.ComponentProps<typeof AlertDialogPrimitive.Content> & AlertDialogProps) {
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
          ...
          <>
            ...
            <AlertDialogFooter >
              <AlertDialogCancel asChild>
                <Button variant="none" className="text-foreground/70 cursor-pointer">{cancelText}</Button>
              </AlertDialogCancel>
              <AlertDialogAction asChild>
                <Button variant="outline" className="cursor-pointer" onClick={onAction}>{actionText}</Button>
              </AlertDialogAction>
            </AlertDialogFooter>
          </>
        )}
